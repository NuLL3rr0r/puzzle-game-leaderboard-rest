...
int main(int argc, char **argv)
{
    try {
        ...
        NowruzPuzzle::RT::Storage()->AppPath = appPath;
        ...
        if(!CoreLib::System::GetLock(lockId, lock)) {
            ...
            NowruzPuzzle::RT::DBTables()->InitTables();
        }
        ...
        NowruzPuzzle::PublicAPIResource publicAPIResource;
        server.addResource(&publicAPIResource, "/NowruzPuzzle");
        if (server.start()) {
